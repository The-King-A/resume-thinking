  ...
  <div class="app-shell">
    <header v-if="auth.isAuthenticated" class="global-nav">
      ...
      <nav class="global-nav-links" aria-label="工作区导航">
        ...
        <RouterLink class="global-nav-link" active-class="global-nav-link-active" :class="{ 'global-nav-link-context-active': route.path === '/match' || route.path.startsWith('/matches/') }" to="/match">匹配</RouterLink>
