...
public class MatchTaskController {
    ...
    @GetMapping("/{taskId}/result") public AnalysisResult result(@RequestAttribute("actorId") UUID actor, @RequestAttribute("role") UserRole role, @PathVariable UUID taskId) { return service.getResult(taskId, actor, role); }
