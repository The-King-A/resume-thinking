...
@Service public class LlmProfileService {
 ...
 public LlmProfile update(String owner,String id,UpdateLlmProfileCommand command){
 ...
 public void delete(String owner,String id){repository.delete(get(owner,id));}
