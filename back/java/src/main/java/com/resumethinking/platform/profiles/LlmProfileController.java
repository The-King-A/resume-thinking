...
public class LlmProfileController {
 ...
 @PutMapping("/{id}") public Response update(@RequestAttribute("actorId") UUID actor,@PathVariable UUID id,@Valid @RequestBody UpdateLlmProfileCommand command){return Response.from(service.update(actor,id,command));}
