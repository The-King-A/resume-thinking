...
public class Resume {
    ...
    public void softDelete(String actorId, UserRole role, Instant now) { status=1; visibilityState=role==UserRole.ADMIN?VisibilityState.ADMIN_SOFT_DELETED:VisibilityState.USER_SOFT_DELETED; softDeletedBy=actorId; softDeletedAt=now; updatedAt=now; }
    ...
    public String getId(){return id;} public String id(){return id;} public String getOwnerId(){return ownerId;} public String getTitle(){return title;} public SourceType getSourceType(){return sourceType;} public String getParserVersion(){return parserVersion;} public byte[] getEncryptedRawContent(){return encryptedRawContent;} public byte[] getRawContentNonce(){return rawContentNonce;} public UserRole getCreatorRole(){return creatorRole;} public int getStatus(){return status;} public VisibilityState getVisibilityState(){return visibilityState;} public Instant getVisibleUntil(){return visibleUntil;} public String getSoftDeletedBy(){return softDeletedBy;} public Instant getSoftDeletedAt(){return softDeletedAt;} public Instant getArchivedAt(){return archivedAt;} public Instant getRestoredAt(){return restoredAt;} public Instant getCreatedAt(){return createdAt;} public Instant getUpdatedAt(){return updatedAt;} public long getVersion(){return version;}
}
